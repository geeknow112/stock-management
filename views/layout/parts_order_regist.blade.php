	...
	<div class="row mb-3">
		...
		<input type="text" class="col-sm-2 col-form-control" id="sales" name="sales" aria-describedby="salesHelp" value="{{$rows->sales}}" readonly>
	</div>
	@endif
...
<!--		<div id="arrivalDtHelp" class="form-text">入庫予定日を入力してください。</div>-->
	...
	<div class="row mb-3">
		...
		<select class="form-select" aria-label="outgoing_warehouse">
