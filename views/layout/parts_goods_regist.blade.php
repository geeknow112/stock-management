	...
	<div class="row mb-3">
		...
		<input type="text" class="col-sm-2 col-form-control w-auto" id="goods_name" name="goods_name" aria-describedby="goodsNameHelp" value="{{$rows->name}}" @if ($get->action != '' && $get->action != 'save' && $get->action != 'edit') readonly @endif>
