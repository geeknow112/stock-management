	...
	public function get_column_info() {
		return array(
			array(
				...
				'pref' => mb_convert_encoding('“s“¹•{Œ§', 'UTF-8', 'SJIS'), 
				'addr1' => mb_convert_encoding('ZŠ‚P', 'UTF-8', 'SJIS'), 
				'addr2' => mb_convert_encoding('ZŠ‚Q', 'UTF-8', 'SJIS'), 
				'addr3' => mb_convert_encoding('ZŠ‚R', 'UTF-8', 'SJIS')
			)
		);
	}
