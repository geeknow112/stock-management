<?php
/**
 * List Table API: YC_Customer_List_Table class
 *
 * @package WordPress
 ...
 * @see WP_List_Table
 */
class YC_Customer_List_Table extends WP_List_Table {
...
//			echo "\n\t" . $this->single_row( $user_object, '', '', isset( $post_counts ) ? $post_counts[ $userid ] : 0 );
			echo '<tr>';
			echo '<td><a href="' . admin_url() . 'admin.php?page=customer-detail&customer='. $object->customer. '&action=edit">'. sprintf('%05d', $object->customer). '</a></td>';
	...
	public function get_column_info() {
		return array(
			array(
				'id' => mb_convert_encoding('ŒÚ‹q”Ô†', 'UTF-8', 'SJIS'), 
				'customer' => mb_convert_encoding('ŒÚ‹q–¼', 'UTF-8', 'SJIS'), 
				'remark' => mb_convert_encoding('”õl', 'UTF-8', 'SJIS'), 
				'rgdt' => mb_convert_encoding('“o˜^“ú', 'UTF-8', 'SJIS'), 
				'updt' => mb_convert_encoding('ÅIXV“ú', 'UTF-8', 'SJIS'), 
				'upuser' => mb_convert_encoding('ÅIXVŽÒ', 'UTF-8', 'SJIS')
			),
			array(
			),
			array(
