...
//			echo "\n\t" . $this->single_row( $user_object, '', '', isset( $post_counts ) ? $post_counts[ $userid ] : 0 );
			...
			echo '<td><a href="' . admin_url() . 'admin.php?page=stock-detail&stock='. $object->stock. '&action=edit">'. sprintf('STOCK-%07d', $object->stock). '</a></td>';
			echo '<td><a href="' . admin_url() . 'admin.php?page=stock-bulk&arrival_dt='. $object->arrival_dt. '&warehouse='. $object->warehouse. '&action=edit">'. $object->arrival_dt. '</a></td>';
			...
			echo '<td><a href="' . admin_url() . 'admin.php?page=stock-lot-regist&stock='. $object->stock. '&goods='. $object->goods. '&arrival_dt='. $object->arrival_dt. '&warehouse='. $object->warehouse. '"> [ '. $object->goods_total. ' ] </a></td>';
