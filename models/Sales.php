...
*/
	...
	public function getList($get = null, $un_convert = null) {
		...
		$sql  = "SELECT s.*, sc.repeat, sc.period, sc.span, sc.week, sc.repeat_s_dt, sc.repeat_e_dt, g.name as goods_name, g.separately_fg, c.*, c.name AS customer_name, s.rgdt AS rgdt, s.updt AS updt, s.upuser AS upuser, s.remark AS remark ";
